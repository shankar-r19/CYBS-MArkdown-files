...
* File name: <span style=" color:blue;"> blue(Bold)</span>
* Method names: <span style=" color:green;">green(Bold and Underlined)
* Variable names: <span style=" color:yellow ;">yellow(Bold and Itaics) 
